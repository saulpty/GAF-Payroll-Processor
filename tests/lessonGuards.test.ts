...
const TO_ISO_ALLOWLIST: Record<string, number> = {
  // One use left: it coerces an already-anchored Date, not live "now". The
  // other two went with computeTrends on 2026-09-10 (Trends tab deleted). This
  // module must stay import-free or `node --test` cannot resolve it, which
