...
--
-- migration_id: 1781290200_fix_view_dual_time_format
-- name:         fix view dual time format
-- applied_at:   2026-06-16 15:15:57
-- applied_by:   system
-- checksum:     afe46f120b4bf9a8084275510acc171cf50660ca2b6e3165a6625a83b40ec23a
--
...
-- Fix: entry_time column has two formats: "8:03 AM" (12h) and "10:50:00" (24h HH:MM:SS).
-- Use a CASE to pick the right to_timestamp pattern before casting to ::time.
...
parsed AS (
  SELECT
    b.*,
    -- Handle both "8:03 AM" (12h) and "10:50:00" (24h HH:MM:SS) formats
    CASE
